            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body" style="background: url({{asset('/image/user2.png')}});">
                  <a href="penyakit/tambah" class="btn mb-1" style="background-color: #7EA6BF;">Tambah Penyakit Baru</a>
                  @if (session('status'))
                    ...
                    <tbody>
                      ...
                      @foreach ($penyakit as $key)
                        <tr>
                          ...
                          <td>{{ $key->solusi }}</td>
                          <td>
                            <a class="btn" style="background-color: #83C75C;" href="/admin/penyakit/edit/{{ $key->id }}">Edit</a>
